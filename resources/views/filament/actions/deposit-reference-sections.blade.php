            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                ...
                <tbody>
                    @foreach ($rates as $rate)
                        <tr @if($rate['type'] === 'special') style="font-weight: bold; color: green;" @endif>
                            <td style="padding: 8px 12px; border-top: 1px solid #e5e7eb;">{{ $rate['type'] == 'special' ? 'Your Special Rate' : 'Regular Rate' }}</td>
